...
{
    class SpellEffects3PhysicsComponent : IPhysicsComponent
    {
        private int timeToLive;
        private readonly BfbVector _acceleration;
        private Random _random;

        public SpellEffects3PhysicsComponent()
        {
            timeToLive = 3;
        ...
        public void Update(SimulationEntity simulationEntity, Simulation simulation)
        {
            ...
            simulationEntity.DesiredVector.X = _acceleration.X * _random.Next(-10, 10);
            simulationEntity.DesiredVector.Y = _acceleration.Y * _random.Next(-10, 10);
