...
namespace BFB.Engine.Simulation.InputComponents
{
    ...
    {
        SimulationEntity closestEntity = null;
        ...
        public void Update(SimulationEntity entity, Simulation simulation)
        {
            ...
            if(closestEntity != null)
            {
                ...
                entity.DesiredVector.X = 0;
                entity.DesiredVector.Y = 0;
                //Moves entity left
                if (closestEntity.Position.X < entity.Position.X)
                {
                    entity.DesiredVector.Add(new BfbVector(-1,0));
                }
                //Moves entity right
                if (closestEntity.Position.X > entity.Position.X)
                {
